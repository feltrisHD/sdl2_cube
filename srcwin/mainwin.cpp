#define SDL_MAIN_HANDLED  // This should be defined before including SDL_main.h
...
TTF_Font* font = nullptr; // Declare font globally
...
int main(int argc, char* args[]) {
    ...
    font = TTF_OpenFontRW(rw, 1, 30); // Initialize font globally
